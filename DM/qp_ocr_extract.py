#!/usr/bin/env python3
"""OCR all PDF files in DM using pypdfium2 + pytesseract."""
...
def ocr_page(page: pdfium.PdfPage, scale: float) -> str:
    ...
    # Basic preprocessing for scanned PDFs.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="OCR DM PDF files")
    parser.add_argument(
        "--input-dir",
        default="/Users/eric/Documents/StudyCollege/DM",
